...
router.put("/order-approve", auth.auth);
...
router.get("/order-forwarder/:id", auth.auth);
router.put("/order-forwarder-ready/:id", auth.auth);
router.put("/order-forwarder-reject/:id", auth.auth);
router.get("/store-owner/order-forwarder/:id", auth.auth);
